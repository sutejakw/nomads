            ...
            <div class="section-popular-travel row justify-content-center">
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="card-travel text-center d-flex flex-column"
                        style="background-image: url('frontend/images/beratan.jpg');">
                        <div class="travel-country">INDONESIA</div>
                        <div class="travel-location">BERATAN, BALI</div>
                        <div class="travel-button mt-auto">
                        <a href="{{ url('/detail') }}" class="btn btn-travel-details">
                                View Details
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="card-travel text-center d-flex flex-column"
                        style="background-image: url('frontend/images/nusa.jpg');">
                        <div class="travel-country">INDONESIA</div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="card-travel text-center d-flex flex-column"
                        ...
                        <div class="travel-button mt-auto">
                        <a href="{{ route('detail') }}" class="btn btn-travel-details">
                                View Details
                            </a>
                        </div>
                    </div>
