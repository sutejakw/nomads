...
<head>
    ...
    <div style="background-color:#E4E6EB;">
                    ...
                    <tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                ...
                                <img height="auto" src="{{ url('storage/' . $data->travel_package->galleries->first()->image) }}"
                                    style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;"
                                    width="550" />
                                {{-- <img height="auto" src="{{ url($data->travel_package->galleries[0]->image) }}"
                                    style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;"
                                    width="550" /> --}}
                                </td>
                            </tr>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
            ...
            <tr>
                <td
                style="direction:ltr;font-size:0px;padding:20px 0;padding-bottom:10px;padding-top:20px;text-align:center;">
                <!--[if mso | IE]>
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <td align="center" bgcolor="#FF9E53" role="presentation"
                                        ...
                                        style="display:inline-block;background:#FF9E53;color:#ffffff;font-family:Assistant, Helevetica, Arial, sans-serif;font-size:18px;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:10px;">
                                        Check Detail </a>
                                    </td>
                                    </tr>
                                </table>
                ...
                <div class="mj-column-per-100 mj-outlook-group-fix"
                    ...
                    <tr>
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" border="0"
                            ...
                            <td
                                style="font-size: 18px; padding-left: 10px; color: #071C4D; font-family: Assistant, Helevcetica, Arial, sans-serif; line-height: 28px">
